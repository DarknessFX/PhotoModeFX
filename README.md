...
PhotoModeFX project files are light weight with 1,532KB (zipped) but readme screenshots raises it to 41,403Kb (zipped).<br/>
The irony of a generic photographic system being lighter than the photos it takes wasn't missed.<br/>
