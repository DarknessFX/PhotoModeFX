...
Delete the .git_img* folder (if you download/clone from main instead of <a href="https://github.com/DarknessFX/PhotoModeFX/releases/download/v1.0/PhotoModeFX.zip">release package</a>).<br/>
